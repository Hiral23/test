...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php 
			...
			if(isset($model->acdm_name))
				...
				echo $form->dropDownList($model,'acdm_name',array('prompt' => '---------------Select-------------'),array('tabindex'=>3)); 
		?><span class="status">&nbsp;</span>
	...
	<div class="row">
		...
		<?php 
			...
			if(isset($model->div))
				...
				echo $form->dropDownList($model,'div',array('prompt' => '---------------Select-------------'),array('tabindex'=>3)); 
		?><span class="status">&nbsp;</span>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'subject',SubjectMaster::items(), array('empty' => '---------------Select-------------','tabindex'=>6)); ?><span class="status">&nbsp;</span>
