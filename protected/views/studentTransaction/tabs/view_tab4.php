...
<div class = "row_all_vm">
	<div class="rowv">
		...
		<div class="row_b">
			<?php echo $model->Rel_Student_Address->student_address_c_line1 .'<br>'; ?>
		</div>
	</div>
	...
	<div class="rowv">
		<?php echo '<lable><b>Line1 :</b></lable>'; ?>
		<div class="row_b">
			<?php echo $model->Rel_Student_Address->student_address_p_line1 .'<br>'; ?>
		</div>
	</div>
</div>
...
<div class = "row_all_v">
	<div class="rowv">
		...
		<div class="row_b">
			<?php echo $model->Rel_Student_Address->student_address_c_line2 .'<br>'; ?>
		</div>
	</div>
	...
	<div class="rowv">
		<?php echo '<lable><b>Line2 :</b></lable>'; ?>
		<div class="row_b">
			<?php echo $model->Rel_Student_Address->student_address_p_line2 .'<br>'; ?>
		</div>
	</div>
</div>
...
<div class = "row_all_v">
	<div class="rowv">
		...
		<div class="rown">
			<?php echo $model->Rel_Student_Address->student_address_c_pin .'<br>'; ?>
		</div>
	</div>
	...
	<div class="rowv">
		<?php echo '<lable><b>Pincode :</b></lable>'; ?>
		<div class="rown">
			<?php echo $model->Rel_Student_Address->student_address_p_pin .'<br>'; ?>
		</div>
	</div>
</div>
