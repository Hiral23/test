...
//	array('label'=>'List Inward', 'url'=>array('index')),
	...
	array('label'=>'', 'url'=>array('assetsDetails/create','id'=>$model->id),'linkOptions'=>array('class'=>'details','title'=>'Add Assets Details')),
...
//               'id',
	//	'inward_id',
		...
		array(
			...
			'buttons'=>array(
				'delete' => array(
		                        'label'=>'Update assets', // text label of the button
					'url'=>'Yii::app()->createUrl("assetsDetails/delete", array("id"=>$data->id))',
					),
		                'update' => array(
		                        'label'=>'Update assets', // text label of the button
					'url'=>'Yii::app()->createUrl("assetsDetails/update", array("id"=>$data->id))',
		                ),
			),
