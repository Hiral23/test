...
--
-- Host: localhost
-- Generation Time: May 30, 2012 at 05:25 PM
...
(4, 'extra', 200, 2, '2012-05-30 11:32:42', NULL);
...
--
DROP TRIGGER IF EXISTS `totalfeesamt`;
DELIMITER //
CREATE TRIGGER `totalfeesamt` AFTER INSERT ON `fees_master_transaction`
 FOR EACH ROW BEGIN
...
SELECT fees_details_amount into amt from fees_details_table where fees_details_id=feesdetailid;

SELECT fees_master_total into feetotal from fees_master where fees_master_id=feesmasterid;

update fees_master SET fees_master_total = feetotal + amt where fees_master_id=feesmasterid;
...
(32, 94, 33, 4, 1, 1, 33, 11, 1, 1, 1, 85, 33, 1, NULL, 2);
...
(1, '10:35:00', 'karmraj', 'krunal', 'meeting', 1, 'ahmedabad', 'test', '1234', 1, 'test1', 'IMG_7076.JPG', 23, 'Male', '11:21:00', 123, 3, 0, '2012-05-28 17:45:17'),
(2, '15:47:03', 'Ravi Thanki', 'Krunal', 'Visiting', 4, 'Satelite', 'test1', '2417', 1, 'jkj', 'rudraSoftech.png', 21, 'Male', '03:08:00', 1, 1, 0, '2012-05-28 17:46:47'),
(3, '17:54:31', 'test', 'test 1', 'kllkl', 4, 'jkkjk', 'jkj', '3417', 1, 'hjhj', 'rudraSoftech.png', 23, 'Male', '06:18:00', 1, 1, 0, '2012-05-28 17:56:36'),
(4, '18:00:36', 'kjkjk', 'jkjk', 'jkj', 2, 'jhj', 'jjh', '1', 1, 'kjkj', '', 23, 'Male', '06:15:00', 1, 1, 0, '2012-05-29 10:26:18'),
(5, '10:25:52', 'Ravi Thanki', 'Girish Sir', 'interview', 4, 'Ambavadi', 'Rudra Softech', '4911', 1, 'inteview', 'rudraSoftech.png', 23, 'Male', '01:00:00', 1, 1, 0, '2012-05-29 11:30:48'),
(6, '10:34:08', 'this is test visitor', 'karmraj', 'test', 1, 'test', '', '', 2, '', '', 23, 'Male', '14:00:00', NULL, NULL, 0, '2012-05-30 10:53:31'),
(7, '10:53:12', 'another test', 'this is test', 'tetst', 1, 'test', '', '', 22, 'e', '', 232, 'Male', '15:00:00', NULL, NULL, 1, NULL);
