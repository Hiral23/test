...
class SubjectTextbookController extends RController
{
	/**
	...
	{
		$model=new SubjectTextbook;
		
		// Uncomment the following line if AJAX validation is needed
		$this->performAjaxValidation($model);

		if(isset($_POST['SubjectTextbook']))
		{
			$model->attributes=$_POST['SubjectTextbook'];
			$model->sub_id=$_REQUEST['id'];
			$model->created_by = Yii::app()->user->id;
            		$model->created_date = new CDbExpression('NOW()');
			$model->subject_textbook_type = "GTU Type";
	...
	public function actionOther_create()
	{
		...
		if(isset($_POST['SubjectTextbook']))
		{
			...
			$model->created_by = Yii::app()->user->id;
            		$model->created_date = new CDbExpression('NOW()');
			$model->subject_textbook_type = "Other Type";
	...
	{
		$dataProvider=new CActiveDataProvider('SubjectTextbook');
	...
	{
		$model=new SubjectTextbook('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SubjectTextbook']))
			$model->attributes=$_GET['SubjectTextbook'];
	...
	{
		$model=SubjectTextbook::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='subject-textbook-form')
		{
