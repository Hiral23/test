...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'sending_date'); ?>
		<?php echo $form->textField($model,'sending_date'); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'document_desc',array('size'=>60,'maxlength'=>100)); ?>
	</div>
