...
--
-- Host: localhost
-- Generation Time: Jun 13, 2012 at 06:33 PM
...
(1, 'kru', 'kru-ECE-MCA-test', 1, 2, '2012-06-09 15:54:00', 7, 10, 1, 2, 7),
(2, 'test batch', 'test batch-CE-MCA-test', 1, 2, '2012-06-09 17:33:31', 1, 10, 1, 2, 7);
...
(6, 'krunal', '', 1, 2, '2012-06-09 12:23:41', 1, 3, 9),
(7, 'divA', '', 1, 2, '2012-06-09 13:41:37', 10, 2, 10),
(8, 'divb-CE-MCA-Co. Eng-BCA', '', 1, 2, '2012-06-09 14:14:55', 4, 2, 10),
(9, 'kru-Co. Eng-BCA-ME-Msc IT', '', 1, 2, '2012-06-09 14:16:30', 2, 3, 9),
(10, 'test', 'test-ME-Msc IT', 1, 2, '2012-06-09 14:38:52', 2, 3, 9),
(11, 'hello', 'hello-CE-MCA', 1, 2, '2012-06-09 17:34:54', 1, 2, 7),
(12, 'test123', 'test123-CE-MCA', 1, 2, '2012-06-12 19:11:57', 1, 2, 7);
...
(3, '1111', 'Mehulkumar', 'Kiritbhai', 'Dethariya', '', 'Ramilaben', '1987-08-05', '', 'Male', 'O+', 'Married', 'karmraj.zala@gmail.com', 9879569838, 9925957946, '', 2147483647, '2012-12-07', '', 'NA', 'NA', 'NA', 'NA', '', '', 'Kiritbhai', 'Father', 'NA', '', '', '00000', 'NA', 151, 384265, 11111, 11111, 11111, 'UG', '1111', '', 2, '2012-05-17 13:59:21'),
...
(15, '1111', 'JAYESHKUMAR', 'NATVARLAL', 'SHAH', '', 'CHANDRIKABEN', '1956-04-05', '', 'Male', 'O+', 'Married', 'hirald@rudrasoftech.com', 9879569838, 9825184888, 'AYVPP 3599', 2147483647, '2011-04-17', '', '', '', '', '', '', '', 'KANAIYALAL', 'FATHER', 'NA', 'NA', 'NA', '0', 'NA', 151, 384265, 0, 0, 0, 'NA', '1111', '', 2, '2012-05-21 12:47:24'),
...
(9, 1, 1, 1, 'This is test mail from core team.', 2, 2, '2012-06-13 16:07:58', 3),
(10, 1, 1, 1, 'This is test mail from core team.', 2, 2, '2012-06-13 16:11:38', 3),
(11, 1, 1, 1, 'This is test mail from core team.', 2, 2, '2012-06-13 16:21:20', 3),
(12, 1, 1, 1, 'This is test mail from core team.', 2, 2, '2012-06-13 16:21:29', 15),
(13, 1, 1, 1, 'This is test mail from core team', 2, 2, '2012-06-13 17:28:11', 3),
(14, 1, 1, 1, 'This is test mail from core team', 2, 2, '2012-06-13 17:28:19', 15),
(15, 1, 1, 1, 'fghgfhgf', 2, 2, '2012-06-13 17:38:57', 3),
(16, 1, 1, 1, 'fghgfhgf', 2, 2, '2012-06-13 17:39:04', 15);
...
(37, 2, 1, '2012-06-13 15:56:58', NULL, '::1');
...
(75, '10', '1234', '1234', 1234, 'hiral', 'vikrambhai', 'darji', NULL, 'nandiniben', '2012-06-21', '2012-06-13', 'ahmedabad', 'Female', 'vikrambhai', 'father', '12', 'small buisness', '12000', 'satellite', 3, 380015, 'satellite', 9879569838, 9879569838, 'hirald@rudrasoftech.com', 'hirald@rudrasoftech.com', 'A+', 0, 2, '2012-06-06 18:16:56');
...
--
ALTER TABLE `batch`
  ADD CONSTRAINT `batch_ibfk_1` FOREIGN KEY (`branch_id`) REFERENCES `branch` (`branch_id`),
  ADD CONSTRAINT `batch_ibfk_2` FOREIGN KEY (`div_id`) REFERENCES `division` (`division_id`),
  ADD CONSTRAINT `batch_ibfk_3` FOREIGN KEY (`academic_period_id`) REFERENCES `academic_term_period` (`academic_terms_period_id`),
  ADD CONSTRAINT `batch_ibfk_4` FOREIGN KEY (`academic_name_id`) REFERENCES `academic_term` (`academic_term_id`);
