...
class EmployeeAcademicRecordTrans extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('employee_academic_record_trans_user_id, employee_academic_record_trans_qualification_id, employee_academic_record_trans_eduboard_id, employee_academic_record_trans_year_id, theory_mark_obtained, theory_mark_max, theory_percentage, practical_mark_obtained, practical_mark_max, practical_percentage', 'required','message'=>""),
	...
	public function attributeLabels()
	{
		return array(
			...
			'employee_academic_record_trans_qualification_id' => 'Qualification',
