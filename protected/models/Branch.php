...
class Branch extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('branch_name,branch_alias','CRegularExpressionValidator', 'pattern'=>'/^([A-Za-z&-.\/_  ]+)$/','message'=>''),
...
// The following rule is used by search().
	...
	public function attributeLabels()
	{
		return array(
			'branch_id' => 'Branch',
			'branch_name' => 'Name :',
			'branch_tag_id' => 'Branch Tag Name :',
			'branch_organization_id' => 'Branch Organization',
	...
	public function checkbranch()
		{
			if($this->isNewRecord)
			{
				...
				if($branch_name)
				  {
				 	$this->addError('branch_name',"BranchName already exist.");	
					 return false;	
				  }
				else
			          {
