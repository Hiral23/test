...
class MiscellaneousFeesPaymentCash extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('miscellaneous_fees_payment_cash_amount','length', 'max'=>7),
	...
	public function attributeLabels()
	{
		return array(
			...
			'miscellaneous_fees_payment_cash_receipt_id' => 'Miscellaneous Fees Payment Cash Receipt',
			'miscellaneous_fees_payment_cash_created_by'=> 'Miscellaneous Fees Payment Cash Created By',
			'miscellaneous_fees_payment_cash_creation_date' => 'Miscellaneous Fees Payment Cash Creation Date',
