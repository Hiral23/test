...
class EmployeeInfo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('employee_no, title, employee_first_name, employee_mother_name,employee_middle_name, employee_last_name, employee_dob, employee_gender,employee_type, employee_bloodgroup, employee_marital_status, employee_private_email,  employee_private_mobile, employee_joining_date,  employee_faculty_of, employee_attendance_card_id', 'required','message'=>''),
			...
			array('employee_guardian_income, employee_guardian_city_pin, employee_guardian_phone_no, employee_guardian_mobile1, employee_guardian_mobile2,employee_organization_mobile,employee_private_mobile','numerical', 'integerOnly'=>true ,'message'=>''),

			array('employee_private_email','unique', 'message'=>'email id must be unique'),



			array('employee_organization_mobile, employee_private_mobile, employee_account_no, employee_guardian_occupation_city, employee_guardian_city_pin, employee_guardian_phone_no, employee_guardian_mobile1, employee_guardian_mobile2, employee_created_by', 'numerical', 'integerOnly'=>true ,'message'=>''),
			...
			array('employee_hobbies, employee_technical_skills, employee_project_details, employee_curricular', 'length', 'max'=>100, 'message'=>''),
			array('employee_gender', 'length', 'max'=>6),
			array('employee_bloodgroup', 'length', 'max'=>3),
			array('employee_private_email', 'email','message'=>''),
			...
			array('employee_guardian_phone_no, employee_guardian_mobile1, employee_guardian_mobile2, employee_pancard_no, employee_organization_mobile,employee_private_mobile', 'length', 'max'=>15),
...
//			'employeeTransactions' => array(self::HAS_MANY, 'EmployeeTransaction', 'employee_transaction_employee_id'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'employee_private_mobile' => 'Private Mobile',
			...
			'employee_refer_designation' => 'Refer Designation',
			...
			'employee_guardian_city_pin' => 'City Pin',
			'employee_guardian_phone_no' => 'Phone No',
			'employee_guardian_mobile1' => 'Mobile1',
			'employee_guardian_mobile2' => 'Mobile2',
			'employee_faculty_of' => 'Course',
    ...
    public function chkjoindate()
	{
			...
			{					
					$this->addError('employee_joining_date',"Joiningdate mustbe less than current date.");	
					 return false;	
			}
			else
					return true;
    ...
    public function chkbdate()
	{
			$currentdate = date('Y-m-d');
			$joiningdate = $this->employee_joining_date;
			if($this->employee_dob > $joiningdate)
			{
				$this->addError('employee_dob',"Birthdate mustbe less than current date and Joiningdate.");	
					 return false;	
			}
			else
					return true;
