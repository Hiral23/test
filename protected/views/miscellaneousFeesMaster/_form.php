...
$name = "Create Miscellaneous Fees";
else
$name = "Update Miscellaneous Fees";
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'miscellaneous_fees_name',array('size'=>40,'maxlength'=>50)); ?><span class="status">&nbsp;</span>
	</div>
