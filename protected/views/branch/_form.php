...
?>
	...
	<div class="row1">
		...
		<?php echo $form->textField($model,'branch_name',array('size'=>40,'maxlength'=>60)); ?><span class="status">&nbsp;</span>
	</div>
	<div class="row1">
		<?php echo $form->labelEx($model,'branch_tag_id'); ?>
		<?php echo $form->error($model,'branch_tag_id'); ?>
		<?php echo $form->dropDownList($model,'branch_tag_id',BranchPassoutsemTagTable::items(), array('empty' => '-----------Select---------')) ?><span class="status">&nbsp;</span>
	</div>

	<div class="row1">
		<?php echo $form->labelEx($model,'branch_alias'); ?>
		<?php echo $form->textField($model,'branch_alias',array('size'=>20,'maxlength'=>20)); ?><span class="status">&nbsp;</span>
