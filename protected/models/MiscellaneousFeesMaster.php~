...
class MiscellaneousFeesMaster extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('miscellaneous_fees_name','CRegularExpressionValidator','pattern'=>'/^([A-Za-z0-9-  ]+)$/','message'=>''),
	...
	public function attributeLabels()
	{
		return array(
			...
			'miscellaneous_organization_id'=>'Miscellaneous organization',
		);
	}
	...
	public function checkmiscellaneousfeesname()
		{
			if($this->isNewRecord)
			{
				...
				{
					$this->addError('miscellaneous_fees_name',"MiscellaneousFeesName already exist.");	
					 return false;	
				}
				else
				{
