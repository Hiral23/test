...
class assignCompanyUserTable extends CActiveRecord
{
	...
	public $user_organization_email_id;
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, assign_user_id, assign_role_id, assign_org_id,user_organization_email_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->with = array('Rel_ass_user');
