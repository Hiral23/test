...
<?php
	    ...
	    $trans_info .= $form->labelEx($model,'employee_transaction_employee_id'); 
	    $trans_info .= $form->textField($model,'employee_transaction_employee_id');
	    $trans_info .= $form->error($model,'employee_transaction_employee_id'); 
	    ...
	    $trans_info .= $form->textField($model,'employee_transaction_emp_photos_id'); 
	    $trans_info .= $form->error($model,'employee_transaction_emp_photos_id'); 
