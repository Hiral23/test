...
class Qualification extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('qualification_name, qualification_organization_id, qualification_created_by, qualification_created_date', 'required','message'=>''),
			...
			array('qualification_name', 'unique','message'=>'Already Exist.'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'qualification_created_date' => 'Created Date :',
		);
	}
