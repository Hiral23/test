...
class Quota extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			'quota_id' => 'Quota',
			'quota_name' => 'Name :',
			'quota_organization_id' => 'Quota Organization',
			'quota_created_by' => 'Created By :',
			'quota_created_date' => 'Created Date :',
		);
	}
	...
	public function checkquota()
		{
			if($this->isNewRecord)
			{
				...
				if($quota_name)
				{
					$this->addError('quota_name',"QuotaName already exist.");	
					 return false;	
				}
				else
				{
			...
			else
			{
				...
				if($quota_name)
				  {
				 	$this->addError('quota_name',"QuotaName Name already exist.");	
					 return false;	
				  }
				else
			          {
