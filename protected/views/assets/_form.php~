...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'invoice_description',array('size'=>40,'maxlength'=>100)); ?><span class="status">&nbsp;</span>
	...
	<div class="row">
		...
		<?php echo CHtml::form('','post',array('enctype'=>'multipart/form-data')); ?><span class="status">&nbsp;</span>
