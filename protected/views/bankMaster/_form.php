...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'bank_full_name',array('size'=>40,'maxlength'=>60)); ?><span class="status">&nbsp;</span>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'bank_short_name'); ?>
		<?php echo $form->textField($model,'bank_short_name',array('size'=>40,'maxlength'=>15)); ?><span class="status">&nbsp;</span>
