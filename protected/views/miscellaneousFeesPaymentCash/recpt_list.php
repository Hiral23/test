	...
	<div class="rcpt_content">
		<div class="id_date">
			<div class="rcpt_no">
			    ...
			    <span class="rcpt_id"><?php echo $misc_fees_payment->miscellaneous_fees_payment_cash_receipt_id; ?></span>
      			</div>	
			<div class="rcpt_date">
		...
		<div class="rcpt_name">
		  ...
		  <span class="rcpt_s_name"><?php echo $stud_model->student_last_name.' '.$stud_model->student_first_name.' '.$stud_model->student_middle_name ; ?></span>
		</div>
		<div class="rcpt_dtl">
