...
<?php
        ...
        $tab_2 = $this->renderPartial('tabs/_tab2', array('form'=>$form,'info'=>$info),true);
        $tab_3 = $this->renderPartial('tabs/_tab3', array('form'=>$form,'info'=>$info,'model'=>$model,'lang'=>$lang),true);
