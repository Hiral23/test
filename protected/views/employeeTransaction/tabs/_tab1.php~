...
<div class="row">
	<div class="row-left">
		...
		<?php  $this->widget('zii.widgets.jui.CJuiDatePicker', array(
			...
			'htmlOptions'=>array(
			'style'=>'width:110px;vertical-align:top','tabindex'=>3
		    ),
	...
	<div class="row-right">
	      <?php echo $form->labelEx($info,'employee_probation_period'); ?>
               <?php echo $form->textField($info,'employee_probation_period',array('size'=>18,'maxlength'=>10,'tabindex'=>4)); ?><span class="status">&nbsp;</span>
...
<div class="row">
	...
	<div class="row-left">
	      ...
	      <?php echo $form->dropDownList($model,'employee_transaction_designation_id',EmployeeDesignation::items(), array('empty' => '-----------Select---------','tabindex'=>5)); ?><span class="status">&nbsp;</span>
	...
	<div class="row-right">
	      ...
	      <?php echo $form->dropDownList($model,'employee_transaction_department_id',Department::items(), array('empty' => '-----------Select---------','tabindex'=>6)); ?><span class="status">&nbsp;</span>
...
<div class="row">
	...
	<div class="row-left">
	      ...
	      <?php echo $form->dropDownList($model,'employee_transaction_shift_id',Shift::items(), array('empty' => '-----------Select---------','tabindex'=>7)); ?><span class="status">&nbsp;</span>
...
<div class="row">
		...
		<?php echo $form->dropdownList($info,'title',$info->getTitleOptions(), array('empty' => '-----------Select---------','tabindex'=>9)); ?><span class="status">&nbsp;</span>
...
<?php echo $form->textField($info,'employee_first_name',array('size'=>18,'maxlength'=>25,'tabindex'=>10)); ?><span class="status">&nbsp;</span>
		 <?php echo $form->error($info,'employee_first_name'); ?>
	</div>

	<div class="row-right">
              <?php echo $form->labelEx($info,'employee_middle_name'); ?>
              <?php echo $form->textField($info,'employee_middle_name',array('size'=>18,'maxlength'=>25,'tabindex'=>11)); ?><span class="status">&nbsp;</span>
...
<div class="row">
	...
	<div class="row-right">
		<?php echo $form->labelEx($info,'employee_mother_name'); ?>
              <?php echo $form->textField($info,'employee_mother_name',array('size'=>18,'maxlength'=>25,'tabindex'=>13)); ?><span class="status">&nbsp;</span>
...
<div class="row">
	<div class="row-left">
		...
		<?php  $this->widget('zii.widgets.jui.CJuiDatePicker', array(
			...
			'htmlOptions'=>array(
			'style'=>'width:170px;vertical-align:top','tabindex'=>14
		    ),
	...
	<div class="row-right">
		<?php echo $form->labelEx($info,'employee_birthplace'); ?>
              <?php echo $form->textField($info,'employee_birthplace',array('size'=>18,'maxlength'=>25,'tabindex'=>15)); ?><span class="status">&nbsp;</span>
...
<div class="row">
	<div class="row-left">
	      <?php echo $form->labelEx($info,'employee_gender'); ?>
              <?php echo $form->dropDownList($info,'employee_gender',$info->getGenderOptions(), array('empty' => '-----------Select---------','tabindex'=>16)); ?><span class="status">&nbsp;</span>
              <?php echo $form->error($info,'employee_gender'); ?>
	</div>

	<div class="row-right">
		<?php echo $form->labelEx($info,'employee_bloodgroup'); ?>
              <?php echo $form->dropDownList($info,'employee_bloodgroup',$info->getBloodGroup(), array('empty' => '-----------Select---------','tabindex'=>17)); ?><span class="status">&nbsp;</span>
...
<div class="row">
	...
	<div class="row-left">
	      ...
	      <?php echo $form->dropDownList($model,'employee_transaction_nationality_id',Nationality::items(), array('empty' => '-----------Select---------','tabindex'=>18)); ?><span class="status">&nbsp;</span>
	      <?php echo $form->error($model,'employee_transaction_nationality_id'); ?>
	</div>

	<div class="row-right">
		<?php echo $form->labelEx($info,'employee_marital_status'); ?>
              <?php echo $form->dropDownList($info,'employee_marital_status',$info->getMaritialStatus(), array('empty' => '-----------Select---------','tabindex'=>19)); ?><span class="status">&nbsp;</span>
...
<div class="row">
	...
	<div class="row-left">
	      ...
	      <?php echo $form->dropDownList($model,'employee_transaction_religion_id',Religion::items(), array('empty' => '-----------Select---------','tabindex'=>20)); ?><span class="status">&nbsp;</span>
	      <?php echo $form->error($model,'employee_transaction_religion_id'); ?>
	</div>

	<div class="row-right">
	      <?php echo $form->labelEx($info,'employee_pancard_no'); ?>
               <?php echo $form->textField($info,'employee_pancard_no',array('size'=>18,'maxlength'=>15,'tabindex'=>21)); ?><span class="status">&nbsp;</span>
...
<div class="row">
	...
	<div class="row-left">
	      <?php echo $form->labelEx($info,'employee_account_no'); ?>
               <?php echo $form->textField($info,'employee_account_no',array('size'=>18,'maxlength'=>20,'tabindex'=>22)); ?><span class="status">&nbsp;</span>
               <?php echo $form->error($info,'employee_account_no'); ?>
	</div>

	<div class="row-right">
	      <?php echo $form->labelEx($model,'employee_transaction_category_id'); ?>
	      <?php echo $form->dropDownList($model,'employee_transaction_category_id',Category::items(), array('empty' => '-----------Select---------','tabindex'=>23)); ?><span class="status">&nbsp;</span>
...
<div class="row">
	...
	<div class="row-left">
              ...
              <?php echo $form->dropDownList($info,'employee_type',array(""=>"---------Select---------","1"=>"Teaching","0"=>"Non Teaching"),array('tabindex'=>24)); ?><span class="status">&nbsp;</span>
              <?php echo $form->error($info,'employee_type'); ?>
	</div>

	<div class="row-right">
	      <?php echo $form->labelEx($info,'employee_organization_mobile'); ?>
               <?php echo $form->textField($info,'employee_organization_mobile',array('size'=>18,'maxlength'=>15,'tabindex'=>25)); ?><span class="status">&nbsp;</span>
...
<div class="row">
	...
	<div class="row-left">
	      <?php echo $form->labelEx($info,'employee_private_mobile'); ?>
               <?php echo $form->textField($info,'employee_private_mobile',array('size'=>18,'maxlength'=>15,'tabindex'=>26)); ?><span class="status">&nbsp;</span>
               <?php echo $form->error($info,'employee_private_mobile'); ?>
	</div>

	<div class="row-right">
	      <?php echo $form->labelEx($info,'employee_private_email'); ?>
              <?php echo $form->textField($info,'employee_private_email',array('size'=>18,'maxlength'=>60,'tabindex'=>27)); ?><span class="status">&nbsp;</span>
	</div>
...
<div class="row">
	      ...
	      <?php echo CHtml::activeFileField($photo, 'employee_photos_path',array('tabindex'=>28)); ?><span class="status">&nbsp;</span>
	      <?php CHtml::endForm(); ?>
