...
class Eduboard extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('eduboard_name', 'unique','message'=>'Already Exist.'),
			array('eduboard_name','CRegularExpressionValidator','pattern'=>'/^([A-Za-z.  ]+)$/','message'=>''),
	...
	public function attributeLabels()
	{
		return array(
			...
			'eduboard_created_date' => 'Created Date :',
		);
	}
