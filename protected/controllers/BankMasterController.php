...
class BankMasterController extends RController
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['BankMaster']))
		{
			...
			$model->bank_organization_id=Yii::app()->user->getState('org_id');
			if($model->save())
	...
	{
/*		$dataProvider=new CActiveDataProvider('BankMaster');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bank-master-form')
		{
