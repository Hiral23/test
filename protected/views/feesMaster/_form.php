...
-->
	<div class="row">
		<?php echo $form->labelEx($model,'fees_branch_id'); ?>
	        <?php echo $form->dropDownList($model,'fees_branch_id',Branch::items(), array('empty' => '----------Select--------')); ?><span class="status">&nbsp;</span>
	...
	<div class="row">
		...
		<?php
			...
			'ajax' => array(
			'type'=>'POST', 
			'url'=>CController::createUrl('FeesMaster/getItemName'), 
	...
	<div class="row">
		<?php echo $form->labelEx($model,'fees_quota_id'); ?>
	        <?php echo $form->dropDownList($model,'fees_quota_id',Quota::items(), array('empty' => '----------Select--------')); ?><span class="status">&nbsp;</span>
