...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row1">
		...
		<?php echo $form->textField($model,'division_name',array('size'=>40,'maxlength'=>60)); ?><span class="status">&nbsp;</span>
	</div>

	<div class="row1">
		<?php echo $form->labelEx($model,'branch_id'); ?>
		<?php echo $form->error($model,'branch_id'); ?>
		<?php echo $form->dropDownList($model,'branch_id',Branch::code(), array('empty' => '-----------Select---------')) ?><span class="status">&nbsp;</span>
	</div>
...
<div class="row1">
		...
		<?php
			...
			'ajax' => array(
			'type'=>'POST', 
			'url'=>CController::createUrl('Division/getItemName'), 
