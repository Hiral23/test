...
$name = "Create Academic Term Periods";
else
$name = "Update Academic Term Periods";
...
<!--	<div class="row">
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'academic_term_period',array('size'=>40,'maxlength'=>60)); ?><span class="status">&nbsp;</span>
	</div>
<!--
	<div class="row">
