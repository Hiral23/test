	...
	public function actionCreate()
	{
		...
		if(isset($_POST['EmployeeExperience']))
		{
			...
			if($valid)
			{
				...
				$datetime1 = date_create($emp_exp->employee_experience_to);
				$datetime2 = date_create($emp_exp->employee_experience_from);
				...
				$this->redirect(array('employeeTransaction/final_view','id'=>$model->employee_experience_trans_user_id));
			}
