...
?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'batch_name',array('size'=>40,'maxlength'=>60)); ?><span class="status">&nbsp;</span>
	</div>
	<div class="row1">
		...
		<?php
			...
			'ajax' => array(
			'type'=>'POST', 
			'url'=>CController::createUrl('Batch/getItemName'), 
	...
	<div class="row1">
		...
		<?php
			echo $form->dropDownList($model,'branch_id',
				...
				'ajax' => array(
				'type'=>'POST', 
				'url'=>CController::createUrl('Batch/getItemName1'),	 	
...
<span class="status">&nbsp;</span>
	...
	<div class="row1">
		...
		<?php echo $form->dropDownList($model,'div_id',Division::items(), array('empty' => '-----------Select---------')) ?><span class="status">&nbsp;</span>
	</div>
	<div class="row1">
		<?php echo $form->labelEx($model,'subject_id'); ?>
		<?php echo $form->error($model,'subject_id'); ?>
		<?php echo $form->dropDownList($model,'subject_id',SubjectMaster::items(), array('empty' => '-----------Select---------')) ?><span class="status">&nbsp;</span>
	</div>
