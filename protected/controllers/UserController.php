...
/*	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','change','Changestudpassword','Changeemppassword'),
				'users'=>array('*'),
			),
...
*/
	...
	public function actionUpdate_stud_password($id)
	{
		...
		$this->redirect(array('user/resetstudpassword','id'=>$_REQUEST['id']));
	...
	public function actionUpdate_emp_password($id)
	{
		...
		$this->redirect(array('user/resetemppassword','id'=>$_REQUEST['id']));
